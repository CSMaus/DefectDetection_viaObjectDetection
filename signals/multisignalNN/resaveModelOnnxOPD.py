...
export_model_to_onnx(model, f'models/{attempt}-MultiSignalClassifier_model{modelname}.pth',
                     f'models/{attempt}-MultiSignalClassifier_model{modelname}.onnx', signal_length, hidden_sizes)
