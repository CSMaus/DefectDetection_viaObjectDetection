...
def plot_predictions(defect_probs, defect_starts, defect_ends):
...
model_path = 'models/002-MultiSignalClassifier_modelOPD.pth'

hidden_sizes = [128, 64, 32]
num_heads = 4
defect_probs, defect_starts, defect_ends = load_and_predict(
    model_path, signal_set_path, num_signals_per_set, signal_length, device)
