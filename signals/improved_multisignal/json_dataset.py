...
class JsonSignalDataset(Dataset):
    ...
    def _load_all_json_files(self):
        ...
        for json_file in self.json_files:
            ...
            try:
                ...
                for beam_key, beam_data in data.items():
                    ...
                    # Process signals for this beam (equivalent to processing txt files in a beam folder)
                    signals = []
                    labels = []
                    defect_positions = []
                    
                    for filename in signal_files[:self.seq_length]:
                    ...
                    # Pad sequences if needed (not in the original implementation, but needed for fixed length)
                    ...
                    # Add to dataset (exactly as in the original implementation)
        ...
        print(f"Total beams: {total_beams}, Beams with defects: {beams_with_defects}")
