#!/usr/bin/env python3
"""
Generate ONLY the first video: Signal Input Visualization
"""
...
def main():
    ...
    print("Signal Input Video Generator")
    print("=" * 40)
    print("Generating ONLY the first video: Signal Input Visualization")
    print("Using REAL HybridBinaryModel and REAL data")
    print("=" * 40)
    
    # Generate ONLY the first video
    success = run_manim_scene("detailed_neural_pipeline.py", "SignalInputVisualization")
